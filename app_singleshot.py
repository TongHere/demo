...
def main():
    ...
    if 'prompt' not in st.session_state:
        st.session_state.prompt = """Stelle als Marketingmanager kurz unser neues Softwareprodukt potenziellen Kunden vor und biete einen speziellen Rabatt für frühe Anwender an. Einen speziellen Rabatt für frühe Anwender einschließen. Verwenden Sie Aufzählungspunkte wie: Erreichtes Ziel durch Aktion/Maßnahme, resultierend in Ergebnis/Auswirkung.
"""
