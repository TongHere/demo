...
def main():
    ...
    if 'prompt' not in st.session_state:
        st.session_state.prompt = """You are Marketing manager. Write an short email to potential clients introducing our new software product and offering a special discount for early adopters."""
